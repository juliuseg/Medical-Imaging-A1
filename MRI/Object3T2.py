...
v1_info = nib.load(path + '3D_T2w_20240920074836_A1B1.nii.gz').header
v1 = nib.load(path + '3D_T2w_20240920074836_A1B1.nii.gz').get_fdata()
...
slice_index = 175  # Get the middle slice along the third axis (axial)
...
#Fra 64 til 665 z
sagittal_slice_index = 175  # Adjust as needed
...
axial_x_mm_start, axial_x_mm_end = 92, 113
axial_y_mm_start, axial_y_mm_end = 75, 95

# Coronal slice (x, z) in mm
coronal_x_mm_start, coronal_x_mm_end = 88, 113
coronal_z_mm_start, coronal_z_mm_end = 36, 64

# Sagittal slice (y, z) in mm
sagittal_y_mm_start, sagittal_y_mm_end = 73, 95
sagittal_z_mm_start, sagittal_z_mm_end = 36, 65
