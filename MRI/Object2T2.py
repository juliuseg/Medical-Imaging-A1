...
slice_index = 250  # Get the middle slice along the third axis (axial)
...
axial_x_mm_start, axial_x_mm_end = 107, 124
axial_y_mm_start, axial_y_mm_end = 74, 91

# Coronal slice (x, z) in mm
coronal_x_mm_start, coronal_x_mm_end = 102, 146
coronal_z_mm_start, coronal_z_mm_end = 24, 108

# Sagittal slice (y, z) in mm
sagittal_y_mm_start, sagittal_y_mm_end = 74, 92
sagittal_z_mm_start, sagittal_z_mm_end = 48, 85
